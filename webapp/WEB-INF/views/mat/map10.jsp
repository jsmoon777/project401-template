...
var infowindow = new kakao.maps.InfoWindow({zIndex: 1});
  ...
  var mapOption = { 
   ...
   // 키워드로 장소를 검색
    ps.keywordSearch('제주도맛집', placesSearchCB); 
...
<script>
  function test(data){
	  ...
	  $(function(){
			$.ajax({
				url : 'http://localhost:9090/getlocal?area=9',
				data: {
					keyword : $('#keyword').val(),
...
<div id="div1"></div>
<div id="div_2">
  <iframe width="530" height="315" src="https://www.youtube.com/embed/aJ4o0n7yFMA?autoplay=1&mute=1" title="YouTube video player" 
