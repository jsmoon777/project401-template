...
var infowindow = new kakao.maps.InfoWindow({zIndex: 1});
  ...
  var mapOption = { 
   ...
   // 키워드로 장소를 검색
    ps.keywordSearch('충청남도 맛집', placesSearchCB); 
...
<script>
  function test(data){
	  ...
	  $(function(){
			$.ajax({
				url : 'http://localhost:9090/getlocal?area=4',
				data: {
					keyword : $('#keyword').val(),
...
<div id="div_2">
  <iframe width="530" height="315" src="https://www.youtube.com/embed/Qi0ShbyyonE?autoplay=1&mute=1" title="YouTube video player" 
