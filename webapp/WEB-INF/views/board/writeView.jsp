...
<%@include file="/WEB-INF/include/sub_header.jsp" %>
	<div style="margin-top:200px; margin-bottom:200px; ">
	   <div class="sns_title_box">
	   		<span class="sns_title">자유게시판 등록<span>
       </div>
	...
	<tr>
		...
		<td colspan="2"><input type="text" id="writer" name="writer" class="chk" title="작성자를 입력하세요." value="${member.userId}" class="sns_txt"/></td>
	<tr>
   ...
   <th for="gdsImg">이벤트 바디포스터</th>
	...
	<tr>
		<td colspan="3">						
			<p style="font-size: 12px;"><a href="/sns/snslist">목록으로 돌아가기</a></p>	
		</td>
	</tr>	
	</table>
	</form>
