  ...
  <nav class="menu_nav">
    <ul class="menu_ul">
			    	...
			    	<ul class="three">
			    		<li>
							...
							<ul>
			    				<li>
				    				<div class="itemBox">
						    			<c:forEach var="board" items="${ boardDateList }">
												<div class="item">
													<a href="/MBoard/View?idx=${ board.idx }&menu_id=${menu_id}">
														<img src="/image3/${ file.sfilename}" />
														<p>${ board.title }</p>
													</a>
												</div>
										</c:forEach>
			    	...
			    	<ul class="four">
			    		<li>
			    			...
			    			<ul>
			    				<li>
				    				<div class="itemBox">
						    			<c:forEach var="board" items="${ boardLikeList }">
												<div class="item">
													<a href="/MBoard/View?idx=${ board.idx }&menu_id=${menu_id}">
														<img src="/image3/${ file.sfilename}" />
														<p>${ board.title }</p>
		...
		<li class="hvr-underline-from-left"><a href="#">문의</a>
			<ul>
				<li><a href="/MBoard/WriteForm?menu_id=MENU01&bnum=0&lvl=0&step=0&nref=0" class="hvr-underline-from-left">신규등록</a></li>
			</ul>
		</li>	
	  </ul>	
	  </div>
